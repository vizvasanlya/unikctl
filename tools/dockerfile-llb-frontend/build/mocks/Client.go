...
func (_m *Client) ResolveImageConfig(ctx context.Context, ref string, opt sourceresolver.Opt) (string, digest.Digest, []byte, error) {
	...
	var r2 []byte
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, string, sourceresolver.Opt) (string, digest.Digest, []byte, error)); ok {
		return rf(ctx, ref, opt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, sourceresolver.Opt) string); ok {
		r0 = rf(ctx, ref, opt)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, sourceresolver.Opt) digest.Digest); ok {
		r1 = rf(ctx, ref, opt)
	} else {
		r1 = ret.Get(1).(digest.Digest)
	}

	if rf, ok := ret.Get(2).(func(context.Context, string, sourceresolver.Opt) []byte); ok {
		r2 = rf(ctx, ref, opt)
	} else {
		if ret.Get(2) != nil {
			r2 = ret.Get(2).([]byte)
	...
	if rf, ok := ret.Get(3).(func(context.Context, string, sourceresolver.Opt) error); ok {
		r3 = rf(ctx, ref, opt)
	} else {
		r3 = ret.Error(3)
	}
...
// ResolveSourceMetadata provides a mock function with given fields: ctx, op, opt
func (_m *Client) ResolveSourceMetadata(ctx context.Context, op *pb.SourceOp, opt sourceresolver.Opt) (resp *sourceresolver.MetaResponse, err error) {
	ret := _m.Called(ctx, op, opt)

	var r0 *sourceresolver.MetaResponse
	var r1 error

	if rf, ok := ret.Get(0).(func(context.Context, *pb.SourceOp, sourceresolver.Opt) (*sourceresolver.MetaResponse, error)); ok {
		return rf(ctx, op, opt)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pb.SourceOp, sourceresolver.Opt) *sourceresolver.MetaResponse); ok {
		r0 = rf(ctx, op, opt)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*sourceresolver.MetaResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *pb.SourceOp, sourceresolver.Opt) error); ok {
		r1 = rf(ctx, op, opt)
	} else {
		r1 = ret.Error(0)
	}
