...
```
unikctl pkg --name helloworld:latest --with-kconfig --plat qemu
```
...
sha256:fe5f6abe40068df5d5e98a08dc2f697faa5d22c064ac890e4f1a160d2999c6c4 1.788kB 1 second        containerd.io/gc.root=true,unikctl.sh/oci.mediaType=application/vnd.oci.image.config.v1+json
```
