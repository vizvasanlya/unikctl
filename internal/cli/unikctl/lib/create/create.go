...
import (
	...
	"unikctl.sh/tui/textinput"
	"unikctl.sh/unikraft/lib/template"
)
...
type CreateOptions struct {
	...
	UpdateRefs      bool   `long:"update-refs" usage:"Softly pack the component so that it is available via unikctl list"`
...
func NewCmd() *cobra.Command {
	cmd, err := cmdfactory.New(&CreateOptions{}, cobra.Command{
		...
		Example: heredoc.Doc(`
			...
			$ unikctl lib create sample-project
		`),
