...
func TestAttributeFlags_StructFields(t *testing.T) {
	attributeFlags := func(t *testing.T, obj any, args ...string) {
		...
		rootCmd, subCmds := []string{"unikctl"}, []string{"cmd1", "subcmd1"}
...
func TestFilterOutRegisteredFlags(t *testing.T) {
	...
	flagOverrides = map[string][]*pflag.Flag{
		"unikctl cmd1":         makeLongFlags("cmd1-override1", "cmd1-override2"),
		"unikctl cmd2":         makeLongFlags("cmd2-override1", "cmd2-override2"),
		"unikctl cmd1 subcmd1": makeLongFlags("subcmd1-override1", "subcmd1-override2"),
		"unikctl cmd1 subcmd2": makeLongFlags("subcmd2-override1", "subcmd2-override2"),
	}

	cmd := makeCommand("unikctl", "cmd1", "subcmd1")
